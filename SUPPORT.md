...
- Un binding con mappings o recibos durables no se puede abandonar ni cambiar de destino: 0.10.0 no ofrece `detach`/`rebind`, incluso después de reconciliar una operación.
- Las operaciones sin herramienta Rovo exacta —por ejemplo transiciones o comentarios si no están expuestos— fallan de forma cerrada.
