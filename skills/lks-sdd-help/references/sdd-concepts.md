...
Los proyectos nuevos de 0.10.0 usan método 1.4.0 y esquema 1.4. Los esquemas 1.0, 1.1, 1.2 y 1.3 permanecen soportados en compatibilidad y su migración nunca se deduce de una actualización. El salto histórico 1.2 → 1.3 conserva método 1.3.0/plugin 0.9.1.
