...
`specs/proposed/LKS-SDD_extension_tracking_operativo_v1.4.md` documenta la propuesta 1.4 de selección del backend de seguimiento y proyección operativa opcional en Jira mediante Atlassian Rovo. Su clasificación es **no canónica**: no forma parte del inventario anterior, no modifica sus hashes y no se presenta como política corporativa aprobada. La implementación 0.10.0 la usa como contrato candidate evaluable; una eventual promoción exigiría una decisión metodológica separada y una incorporación canónica explícita, sin reescribir ninguna fuente previa.
