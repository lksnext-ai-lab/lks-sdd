...
| ChatGPT Work | Está orientado a delegar tareas con un resultado revisable y puede usar archivos, plugins y herramientas aprobadas. | Las herramientas disponibles dependen de la modalidad local o cloud, permisos y configuración. Si no hay acceso a la carpeta, trabajar sobre fuentes adjuntas o transferir los Markdown versionados de forma explícita. | [Get started with ChatGPT Work](https://learn.chatgpt.com/docs/get-started-with-work) |
