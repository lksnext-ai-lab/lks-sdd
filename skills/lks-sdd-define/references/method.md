...
Escriba el contrato 1.5 (`method_version: 1.5.0`, `schema_version: 1.5`) y use las tablas, estados y relaciones declarados para cada artefacto. Los contratos anteriores se rechazan sin escritura y la conversación de definición no ofrece una migración implícita. Antes de confirmar el primer plan, resuelva el único binding de tracking y, si se elige Jira, su alcance de reporting y gate de coordinación; una decisión confirmada se reutiliza en todos sus horizontes hasta una reconsideración explícita.
