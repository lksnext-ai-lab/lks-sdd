...
export function App({ auth, configurationError }: AppProps) {
  ...
  return (
    <main>
      <p className="eyebrow">LKS-SDD · perfil React + OIDC simulado</p>
      <h1>Frontera de identidad simulada</h1>
      <p>El doble no productivo conserva PKCE, sesión y token como contrato explícito.</p>
