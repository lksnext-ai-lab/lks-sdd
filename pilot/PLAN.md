...
Antes de cambiar el estado externo a `running`, `scripts/manage_pilot.py validate-config` debe devolver `ready`. Esto exige muestra, aliases, responsables, soporte, canal confidencial de seguridad, paquete 0.8.0 candidate con checksum, rollback a 0.7.0 confirmado y restricciones de privacidad. El archivo de ejemplo permanece deliberadamente `blocked`.
