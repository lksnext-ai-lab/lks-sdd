...
- Un binding con mappings o recibos durables no se puede abandonar ni cambiar de destino: 0.14.0 no ofrece `detach`/`rebind`, incluso después de reconciliar una operación.
