...
Los proyectos nuevos de 0.14.2 usan método 1.5.0 y esquema 1.5. Los esquemas 1.0, 1.1, 1.2, 1.3, 1.4 y 1.5 permanecen soportados en compatibilidad y su migración nunca se deduce de una actualización. El salto histórico 1.2 → 1.3 conserva método 1.3.0/plugin 0.9.1.
