...
Los proyectos de 0.15.0 usan método 1.5.0 y esquema 1.5 como contrato único. El `plugin_version` del índice es procedencia de materialización, no la versión runtime activa. Actualizar nunca reescribe esos datos ni deduce una migración.
