...
try {
  python scripts\run_quality_harness.py --channel candidate --date $releaseDate --baseline quality\baselines\v0.13.0.json --profile-mode reuse --output $qualityReport
