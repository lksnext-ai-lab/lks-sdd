...
def assess_planning(
    ...
    *,
    ...
    if schema_version == "1.3" and len(matching_targets) != 1:
        gaps.append({
    ...
    planning_index = manifest.get("planning", {}) if schema_version == "1.3" else {}
    ...
    if schema_version == "1.3" and isinstance(planning_index, dict):
        index_is_bound = bool(
    ...
    if not confirmed and schema_version == "1.3" and not fingerprint_stale:
