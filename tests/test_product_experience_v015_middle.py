"""Middle deterministic shard for the LKS-SDD 0.15 product experience."""
...
from test_product_experience_v015 import (
    ...
    PRODUCT_EXPERIENCE_SHARD_BOUNDARY,
...
def load_tests(
    ...
    return unittest.TestSuite(
        ...
        for name in names[
            PRODUCT_EXPERIENCE_SHARD_BOUNDARY:PRODUCT_EXPERIENCE_SECOND_BOUNDARY
        ]
    )
