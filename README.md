...
La versión `2.1.1` de LKS-SDD organiza el desarrollo con agentes alrededor de
...
Plugin 2.1.1, schema 2.0 y método 2.0.0 son versiones distintas. Los consumidores
...
La release técnica estable exige gates y [aprobación propia](quality/release-approval-v2.1.1.json).
