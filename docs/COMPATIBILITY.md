# Compatibilidad de LKS-SDD 0.15.0

## Contrato de proyecto soportado

LKS-SDD 0.15.0 opera exclusivamente sobre proyectos con:
...
La evidencia técnica nueva usa schema 1.2 y registra los bindings seleccionados. Para un único binding, la identidad superior de perfil debe coincidir; para varios bindings no se inventa una identidad superior común. La evidencia G4 completa anterior conserva sus bytes y nunca se migra silenciosamente.
